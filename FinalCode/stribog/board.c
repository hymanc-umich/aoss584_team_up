...
void boardInit(void)
{
  /*
    ...
    palSetPadMode(EI2C_SDA_PORT, EI2C_SDA_PIN, PAL_MODE_ALTERNATE(4) | PAL_STM32_OTYPE_OPENDRAIN);
    palSetPadMode(EI2C_SCL_PORT, EI2C_SCL_PIN, PAL_MODE_ALTERNATE(4) | PAL_STM32_OTYPE_OPENDRAIN);
